...
const homeContent = `
  ...
  <section class="section" aria-labelledby="research-focus-heading">
    <div class="shell">
      ${sectionHeading("01 · Research focus", "Governance for systems that change over time.", "Research on the evidence and authority boundaries that keep autonomous systems accountable in practice.")}
  ...
  <section class="section">
    <div class="shell prose-grid">
      ...
      <article class="prose">
        ...
        <p>I am a Tanzanian-born machine learning engineer, independent researcher, and technology entrepreneur based in Atlanta. My undergraduate studies at the University of Dar es Salaam combined computer science and statistics, culminating in a Bachelor of Science with Computer Science (Honours). I later completed graduate study in business analytics at Emory University, with deeper work in machine learning, data systems, distributed computing, and organizational decision-making.</p>
